...
1. Explain what a token is used for. It tells the browser the user is authenticated and authorized to view privateRoute information.
2. What steps can you take in your web apps to keep your data secure? Build the app to where the user is authorized and authenticated in viewing data that needs to be secured.
3. Describe how web servers work. They 'serve' up information to a user through a router and ISP, at a specific IP address, supplied by the user.
